...
public class SemDatabaseTest extends TestCase {
    ...
    public void testInsert() throws Exception {
        ...
        s.insert(mysem2);
        Seminar mysem = new Seminar(1749, "Seminar Title",
            "2405231000", 1, (short)15, (short)33, 125, keywords,
            "This is a great seminar");
        s.insert(mysem);
        Seminar mysem1 = new Seminar(1, "Seminar Title",
    ...
    public void testSearch() throws Exception {
        ...
        Seminar mysem = new Seminar(1749, "Seminar Title",
            ...
            "This is a great seminar");
        s.insert(mysem);
        Seminar mysem1 = new Seminar(1759, "Seminar Title",
            "2405231000", 1, (short)15, (short)33, 125, keywords,
            "This is a great seminar");
        s.insert(mysem1);
        s.search(1759);
    ...
    public void testPrintHash() throws Exception {
        String[] keywords = { "Good", "Bad", "Ugly" };
        s.insert(mysem2);
        Seminar mysem = new Seminar(2, "Seminar Title",
            "2405231000", 1, (short)15, (short)33, 125, keywords,
            "This is a great seminar");
        s.insert(mysem);
        Seminar mysem1 = new Seminar(3, "Seminar Title",
            "2405231000", 1, (short)15, (short)33, 125, keywords,
            "This is a great seminar");
        s.insert(mysem1);
        Seminar mysem10 = new Seminar(10, "Seminar Title",
